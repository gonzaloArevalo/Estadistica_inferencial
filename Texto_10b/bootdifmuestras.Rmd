...
2.8 , 3.2 , 3.7 , 4.1 , 4.4 , 4.5 , 4.8 , 5.2 , 5.2 , 5.3 , 5.5 , 5.5 , 5.6 , 5.6 , 5.7 , 5.7)
...
print ( qq )
cat ( " Distribuci ó n bootstrap :\ n " )
cat ( " \ tMedia : " , mean ( valores$valores ) , " \ n " )
cat ( " \ tDesviaci ó n est á ndar : " , sd ( valores$valores ) , " \ n \ n " )
