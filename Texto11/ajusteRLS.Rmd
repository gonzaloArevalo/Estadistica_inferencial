...
xlab = " Peso [ lb x 1000] " , ylab = " Rendimiento [ millas / gal ó n ] " )
...
mpg <- c(23.714 , 19.691 , 19.242 , 12.430 , 10.090 , 9.565 , 18.171 , 26.49 , 7.054 ,
...
# Usar el modelo para predecir el rendimiento de l os nuevos
