...
muestra _ L <- c (50916.01 ,61396.89 ,69704.93 ,61133.57 ,79657.66 ,69883.13 ,
...
n _ L <- length ( muestra _ L )

muestra _ M <- c (95075.86 ,
41772.91 ,
73996.43 ,
69378.84 ,
98258.72 ,
...
n _ M <- length ( muestra _ M )

# Obtener tama ñ o del efecto .
tdf <- cohen . d ( muestra _L , muestra _ M )
 cat ( " Tama ñ o del efecto :\ n " )
 print ( tdf )
...
alfa <- 0.05
valor _ nulo <- 10
factores <- pwr . t2n . test ( n1 = n _L , n2 = n _M , d = d , sig . level = alfa ,
